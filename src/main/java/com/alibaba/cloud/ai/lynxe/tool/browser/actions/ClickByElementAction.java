	...
	public ToolExecuteResult execute(BrowserRequestVO request) throws Exception {
		...
		String clickResultMessage = clickAndSwitchToNewTabIfOpened(page, () -> {
			try {
				...
				// Special handling for checkbox inputs: try to find and click the associated label
				// This is especially important for Element UI checkboxes where the input is hidden
				Object checkboxCheckResult = locator.evaluate("el => el && el.tagName === 'INPUT' && el.type === 'checkbox'");
