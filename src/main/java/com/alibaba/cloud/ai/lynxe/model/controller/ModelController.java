 ...
 */
package com.alibaba.cloud.ai.lynxe.model.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.http.ResponseEntity;
import org.springframework.web.bind.annotation.*;

import com.alibaba.cloud.ai.lynxe.model.model.enums.ModelType;
import com.alibaba.cloud.ai.lynxe.model.model.vo.ModelConfig;
import com.alibaba.cloud.ai.lynxe.model.model.vo.ValidationRequest;
import com.alibaba.cloud.ai.lynxe.model.model.vo.ValidationResult;
import com.alibaba.cloud.ai.lynxe.model.service.ModelService;
...
public class ModelController {
	...
	@Autowired
	private com.alibaba.cloud.ai.lynxe.model.repository.DynamicModelRepository dynamicModelRepository;
	...
	public ResponseEntity<Map<String, Object>> getAvailableModels() {
		...
		try {
			...
			List<com.alibaba.cloud.ai.lynxe.model.entity.DynamicModelEntity> configuredModels = dynamicModelRepository
				.findAll();
			...
			com.alibaba.cloud.ai.lynxe.model.entity.DynamicModelEntity defaultModel = configuredModels.stream()
				.filter(com.alibaba.cloud.ai.lynxe.model.entity.DynamicModelEntity::getIsDefault)
				.findFirst()
				.orElse(configuredModels.get(0)); // Fallback to first model if no default
													// found

			List<com.alibaba.cloud.ai.lynxe.model.model.vo.AvailableModel> availableModels = ((com.alibaba.cloud.ai.lynxe.model.service.ModelServiceImpl) modelService)
